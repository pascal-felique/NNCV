...
####################################
resized_image_width=resized_image_width3
resized_image_height=resized_image_height3
patch_width=patch_width3
patch_height=patch_height3
...
def get_args_parser():
    ...
    parser.add_argument("--dice-loss-weight", type=float, default=0.2, help="Weight for the Dice loss contribution")
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images, labels) in enumerate(train_dataloader):
            ...
            total_loss = ce_loss + args.dice_loss_weight * dice
